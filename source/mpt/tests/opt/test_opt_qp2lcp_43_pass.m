function test_opt_qp2lcp_43_pass
%
% mpMIQP with 1 integer, 2 binaries,  4 continous variables, 1 parameter
% 
% - subrank of inequality constraints matrix is bigger than number of
