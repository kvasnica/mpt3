function test_milp_solvers03(solver, tol)
...
% let some variables to be integers
vartype = 'C'*ones(16,1);
vartype(5:10) = 'I';

% solution via CPLEX
xd = [ -9.665861866198117e+00
    -4.160943355862862e-01
    -1.147200544954041e+00
     2.118267718076908e+00
    ...
    -1.000000000000000e+01
    -6.196958151334577e+00
    -8.844228688149003e-01
     8.766740498209144e+00
    -8.175114769665155e+00
    -5.404307827905093e+00
    -9.901126459570659e+00];

fvald = -5.590607860774278e+01;

% use old MPT interface to solve it
%[x1,fval1,how,exfl]=mpt_solveMILP(ones(1,16),A,b,Aeq,beq,-10*ones(16,1),1e4*ones(16,1),char(vartype),[],[],solver);
