...
% DESCRIPTION
% ---------------------------------------------------------------------------
% Computes the set difference between two polyhedra or two arrays of
% polyhedra. Supports lower-dimensional polyhedra.
%
% USAGE:
%   R=P\Q
%
...
% INPUT
% ---------------------------------------------------------------------------
% P   - polyhedron or an array of polyhedra
% Q   - polyhedron or an array of polyhedra
%
% ---------------------------------------------------------------------------
% OUTPUT                                                                                                    
% ---------------------------------------------------------------------------
% R   - polyhedron or an array of polyhedra
%
...
%     2010 Revised by Martin Herceg, Automatic Control Laboratory, ETH Zurich,
