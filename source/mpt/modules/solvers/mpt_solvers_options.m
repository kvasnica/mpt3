...
% if .generator='iterative', active sets are generated one-by-one
% if .generator='batch', active sets are generated by nchoosek
options.enum_pqp.generator = 'iterative';
